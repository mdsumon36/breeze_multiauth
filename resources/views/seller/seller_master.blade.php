...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title>TWC - Responsive Seller Dashboard</title>
    ...
    <body>
                ...
                <ul class="list-unstyled topnav-menu float-right mb-0">
                    ...
                    <li class="dropdown notification-list">
                        <a class="nav-link dropdown-toggle nav-user mr-0 waves-effect waves-light" data-toggle="dropdown" href="#" role="button" aria-haspopup="false" aria-expanded="false">
                            <img src="{{url('backend/assets/images/users/user-1.jpg')}}" alt="user-image" class="rounded-circle">
                        ...
                        <div class="dropdown-menu dropdown-menu-right profile-dropdown ">
                            ...
                            <!-- item-->
                            <a href="{{route('seller.logout')}}" class="dropdown-item notify-item">
        ...
        <script src="{{url('backend/assets/libs/flot-charts/jquery.flot.js')}}"></script>
        <script src="{{url('backend/assets/libs/flot-charts/jquery.flot.time.js')}}"></script>
        <script src="{{url('backend/assets/libs/flot-charts/jquery.flot.tooltip.min.js')}}"></script>
        <script src="{{url('backend/assets/libs/flot-charts/jquery.flot.selection.js')}}"></script>
        <script src="{{url('backend/assets/libs/flot-charts/jquery.flot.crosshair.js')}}"></script>
