               ...
               <div class="col-md-8 col-lg-6 col-xl-5">
                  <div class="card bg-pattern">
                     <div class="card-body p-4">
                        ...
                        @endif
                        <form action="{{route('seller.register.create')}}" method="POST">@csrf
                  ...
                  <div class="row mt-3">
                     <div class="col-12 text-center">
                        ...
                        <p class="text-white-50">Already account? <a href="{{route('seller_login_from')}}" class="text-white ml-1"><b>Login In</b></a></p>
                     </div>
                     <!-- end col -->
                  </div>
                  <!-- end row -->
